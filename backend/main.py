...
def _format_compliance_report_text(report: dict) -> str:
    ...
    lines = [
        ...
        f"Generated by: {report.get('generated_by', 'unknown')} ({report.get('generated_role', 'unknown')})",
        f"Report event ID: {report.get('report_event_id') or report.get('operational_event_id') or 'pending ledger write'}",
        "",
    ...
    lines.extend([
        ...
        f"Generated by: {provenance.get('generated_by', report.get('generated_by', 'unknown'))} ({provenance.get('generated_role', report.get('generated_role', 'unknown'))})",
