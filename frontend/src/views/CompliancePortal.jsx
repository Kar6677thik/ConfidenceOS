            ...
            <div className="industrial-card p-6">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <p className="caption-mono text-[var(--text-muted)] mt-2">
                    Generated by {report.generated_by || report.provenance?.generated_by || 'authenticated user n/a'} ({report.generated_role || report.provenance?.generated_role || 'role n/a'}) / event {report.report_event_id || report.operational_event_id || 'pending ledger write'}
                  </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="caption-mono text-[var(--text-dim)] mt-1">
                    {report.provenance?.generator || 'ConfidenceOS Advisory Engine'} / generated by {report.provenance?.generated_by || report.generated_by || 'n/a'} ({report.provenance?.generated_role || report.generated_role || 'n/a'}) / tamper-evident content hash, not a cryptographic signature.
                  </p>
                </div>
              </div>
            </div>
